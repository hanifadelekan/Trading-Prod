...
ImGuiBBOViewer::ImGuiBBOViewer(GLFWwindow* window,
    ...
    : window_(window),
      disruptor_(disruptor),       // ✅ this initializes the reference!
      obdisruptor_(obdisruptor),   // ✅ this initializes the reference!
...
void ImGuiBBOViewer::RenderFrame(double dir) {
    try {
        ...
        while (disruptor_.consume(bbo_cursor_, latest_snapshot_)) {
        ...
        while (obdisruptor_.consume(imb_cursor_, latest_imb_snapshot_)){
